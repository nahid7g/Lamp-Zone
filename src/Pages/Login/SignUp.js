...
const SignUp = () => {
    ...
    if (gError || error || updateError) {
        loginError = <p className='text-red-500'>{gError?.message || error?.message || updateError.message}</p>
    }
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form className='grid grid-cols-1 gap-2' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {loginError}
                        <button className="btn btn-accent text-white" type='submit'>Sign Up</button>
                    </form>
