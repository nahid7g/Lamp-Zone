...
const MyProfile = () => {
  ...
  useEffect(() => {
    fetch(`https://lamp-zone-server.vercel.app/users?email=${user?.email}`)
      .then((res) => res.json())
  ...
  const onSubmit = (data) => {
    ...
    fetch('https://lamp-zone-server.vercel.app/users', {
      method: 'PUT', // or 'PUT'
      headers: {
    ...
    <div className='bg-base-200 py-5 my-2 px-2'>
      ...
      <div className='hero'>
        <div className='hero-content flex-col lg:flex-row'>
          <img
            ...
            className='mask mask-circle max-w-sm rounded-lg shadow-2xl'
          />
          <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='form-control'>
          ...
          <input
            type='text'
            defaultValue={updateUser?.education}
        ...
        <div className='form-control'>
          ...
          <input
            type='text'
            defaultValue={updateUser?.linkedin}
            className='input input-bordered input-primary w-full max-w-xs'
            {...register('linkedin')}
          />
        </div>
